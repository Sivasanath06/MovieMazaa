      ...
      <nav className="bg-white border-b-2 border-gray-200 dark:bg-gray-900 dark:border-b-1 ">
          <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <Link to="/" className="flex items-center">
                    <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">MovieMazaa</span>
                </Link>
                ...
                <div id='mobile-nav' className="flex md:order-2">
                  ...
                  <div id='nav-search' className={`items-center justify-between ${hidden ? "hidden":""} w-full md:flex md:w-auto md:order-1`}>
